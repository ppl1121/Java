...
public class Board {
    ...
    public Iterable<Board> neighbors(){
    	...
    	if(index_column-1 >= 0){
    		neighborblock[index_row][index_column] = neighborblock[index_row][index_column-1];
    		neighborblock[index_row][index_column-1] = 0;
    		stack.push(new Board(neighborblock));
    		neighborblock[index_row][index_column-1] = neighborblock[index_row][index_column];
    		neighborblock[index_row][index_column] = 0;
    	}
    	if(index_column+1 <= dimension-1){
    		neighborblock[index_row][index_column] = neighborblock[index_row][index_column+1];
    		neighborblock[index_row][index_column+1] = 0;
    		stack.push(new Board(neighborblock));
    		neighborblock[index_row][index_column+1] = neighborblock[index_row][index_column];
    	...
    	if(index_row-1 >= 0){
    		neighborblock[index_row][index_column] = neighborblock[index_row-1][index_column];
    		neighborblock[index_row-1][index_column] = 0;
    		stack.push(new Board(neighborblock));
    		neighborblock[index_row-1][index_column] = neighborblock[index_row][index_column];
    		neighborblock[index_row][index_column] = 0;
    	}
    	if(index_row+1 <= dimension-1){
    		neighborblock[index_row][index_column] = neighborblock[index_row+1][index_column];
    		neighborblock[index_row+1][index_column] = 0;
    		stack.push(new Board(neighborblock));
    		neighborblock[index_row+1][index_column] = neighborblock[index_row][index_column];
